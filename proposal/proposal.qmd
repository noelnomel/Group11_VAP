...
The motivation of the project is to:
...
After viewing the possible outcomes that are affected by individual action, users become more aware an

A RShiny app will be developed to visualise the weather patterns and trends in Singapore over the years, perform statistical analysis as well as forecast future trends, to help the government in their decision-making.
